...
export class News extends Component {
    ...
    async componentDidMount() {
        try {
            ...
            let url = `https://newsapi.org/v2/top-headlines?country=in&category=business
            &apiKey=9225e6d8b8c04de6b9b4d0aaf3d213cc&page=1&pageSize=${this.props.pageSize}`
    ...
    handleNextCase = async () => {
        try {
            ...
            if (this.state.page + 1 > Math.ceil(this.state.totalResult / this.props.pageSize)) {
                ...
                let url = `https://newsapi.org/v2/top-headlines?country=in&category=business
                &apiKey=9225e6d8b8c04de6b9b4d0aaf3d213cc&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`
                let data = await fetch(url);
                let parsedData = await data.json()
                this.setState({
                    article: parsedData.articles,
            ...
            <div className='container'>
                ...
                <div className="row">
...

                    {
                        ...
                        this.state.error && this.state.article.map((element) => {
